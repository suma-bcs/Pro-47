...
if(gameState === "play"){
  ...
  //  coinGroup.destroyEach();
    competition1.velocityX=0;
    competition1.velocityY=0;
    competition2.velocityX=0;
    competition2.velocityY=0;
    competition3.velocityX=0;
    competition3.velocityY=0;
    competition4.velocityX=0;
    competition4.velocityY=0;
    if(keyCode === 32){
      gameState = "play";
      lifes = 3;
      competition1.velocityX = -4;
